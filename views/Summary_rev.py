...
# balance_sheet['IFRS_MONTH']     = pd.to_datetime(balance_sheet['IFRS_MONTH'], errors='coerce', format='%m/%d/%Y')
...
balance_sheet_PAA['IFRS_MONTH'] = pd.to_datetime(balance_sheet_PAA['IFRS_MONTH'], errors='coerce', format='%m/%d/%Y')
...
# csm['IFRS_MONTH']               = pd.to_datetime(csm['IFRS_MONTH'], errors='coerce', format='%m/%d/%Y')
